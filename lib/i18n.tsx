...
const translations: Record<string, Record<string, string>> = {
    English: {
        ...
        "actions.new_note": "New Study Set",
        "actions.new_note_desc": "Create a new set of flashcards or notes.",
        ...
        "profile.total_quizzes_desc": "Study sets and quizzes completed.",
        "profile.accuracy_score": "Accuracy Score",
        "profile.accuracy_score_desc": "Your average performance across sets.",
    ...
    Spanish: {
        ...
        "actions.new_note": "Nuevo Set de Estudio",
        "actions.new_note_desc": "Crea un nuevo set de tarjetas o notas.",
        ...
        "profile.total_quizzes_desc": "Conjuntos y cuestionarios completados.",
        "profile.accuracy_score": "Puntuación de Precisión",
        "profile.accuracy_score_desc": "Tu promedio de rendimiento en todos los conjuntos.",
    ...
    French: {
        ...
        "actions.new_note": "Nouveau Set d'Étude",
        "actions.new_note_desc": "Créez un nouveau set de cartes ou de notes.",
        ...
        "profile.total_quizzes_desc": "Séries d'études et quiz terminés.",
        "profile.accuracy_score": "Score de Précision",
        "profile.accuracy_score_desc": "Votre performance moyenne sur tous les sets.",
    ...
    German: {
        ...
        "actions.new_note": "Neues Lernset",
        "actions.new_note_desc": "Erstelle ein neues Set von Lernkarten oder Notizen.",
        ...
        "profile.total_quizzes_desc": "Abgeschlossene Lernsets und Quizze.",
        "profile.accuracy_score": "Genauigkeit",
        "profile.accuracy_score_desc": "Deine durchschnittliche Leistung über alle Sets.",
    ...
    Dutch: {
        ...
        "actions.new_note": "Nieuwe Studieset",
        "actions.new_note_desc": "Maak een nieuwe set flashcards of notities.",
        ...
        "profile.total_quizzes_desc": "Voltooide studiesets en quizzen.",
        "profile.accuracy_score": "Nauwkeurigheid",
        "profile.accuracy_score_desc": "Je gemiddelde prestaties over alle sets.",
